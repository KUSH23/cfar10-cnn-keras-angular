...
export class WebcamComponent implements AfterViewInit, OnDestroy {
  ...
  public takeSnapshot(): void {
    ...
    context2d.drawImage(this.canvas, 0, 0, _canvas.width, _canvas.height);
    // context2d.drawImage(this.canvas, 0, 0, 32, 32);
    ...
    const dataUrl: string = this.canvas.toDataURL(mimeType, quality);
    ...
    if (this.captureImageData) {
      ...
      // imageData = context2d.getImageData(0, 0, 32, 32);
    }
    // this.idata.imagedata = imageData;
